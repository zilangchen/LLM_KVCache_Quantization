...
phase2_gate_task_rows "Wave 5.2 task $TASK" "$OUT_DIR" "phase2c4_mistral7b_int4mixedkv_*_${TASK}_n${N_SAMPLES}.log" "longbench_task_summary_*.csv" 15 "$TASK" "int4_mixed_kv"
