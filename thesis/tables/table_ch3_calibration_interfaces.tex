\begin{table}[!htbp]
  ...
  \vspace{4pt}
  \parbox{0.96\textwidth}{\footnotesize 注：统一的是离线校准流程与稳健选择纪律，不同路径的差异体现在参数接口与行为代理上；在 \texttt{INT4-RoleAlign} 中，Key 路径由 attention-distribution KL 主导，Value 路径由独立的输出扰动代理主导。}
\end{table}
