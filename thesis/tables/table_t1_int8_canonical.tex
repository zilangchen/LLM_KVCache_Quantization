\begin{table}[!htbp]
  ...
  \\[2pt]\footnotesize 数据来源：\code{results/clean\_rerun\_20260419T09/summary\_phase1.csv}。INT4-RoleAlign 与 KIVI-style 在此表仅为 format 参考值，完整跨模型对比见表~\ref{tab:t2-int4-kivi}。
\end{table}