...
\begin{table}[t]
  ...
  {%
	  ...
	  \begin{tabularx}{\linewidth}{L{1.82cm}C{0.72cm}C{0.82cm}C{0.82cm}C{0.82cm}C{1.62cm}Y}
	    \toprule
	    \multicolumn{7}{l}{\textbf{Panel A. 14B 长序列 TPOT（gen=64, runs=10, H20；ms）}} \\
	    \midrule
	    Backend & 4K & 8K & 16K & 32K & \makecell[c]{$\Delta$ vs.\\torch\_ref} & 备注 \\
	    \midrule
	    ...
	    \makecell[l]{triton\_ra\\(INT4)} & 67.73 & 71.53 & 86.56 & 113.16 & \makecell[c]{4K: -0.44\\8K: -14.54\\16K: -33.26\\32K: -77.08} & fused path \\
	    \midrule
	    \multicolumn{7}{l}{\textbf{Panel B. 跨模型性能交叉边界（$\Delta T=\texttt{triton\_ra}-\texttt{torch\_ref}$；ms）}} \\
	    \midrule
