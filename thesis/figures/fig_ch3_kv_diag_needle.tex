\begin{figure}[!htbp]
  ...
  \begin{tikzpicture}[
    ...
    \node[statebox, fill=safeGreenFill, draw=safeGreen, text=safeGreen!65!black] at (3.25,3.22) {未归零};
    ...
    \node[statebox, fill=safeGreenFill, draw=safeGreen, text=safeGreen!65!black] at (3.25,2.42) {未归零};
    ...
    \node[statebox, fill=safeGreenFill, draw=safeGreen, text=safeGreen!65!black] at (3.25,1.62) {未归零};
