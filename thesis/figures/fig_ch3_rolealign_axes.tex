\begin{figure}[!htbp]
  ...
  \begin{tikzpicture}[
    ...
    \node[font=\bfseries\small] at (0,4.05) {INT4-RoleAlign 的角色感知非对称量化轴};
    ...
    \node[note] (kagg) at (-4.2,-1.6) {沿 token 聚合\\按 channel 独立确定 $(s_K,\zeta_K)$};
    ...
    \node[note] (vagg) at (4.2,-1.6) {沿 channel 聚合\\按 token 独立确定 $(s_V,\zeta_V)$};
