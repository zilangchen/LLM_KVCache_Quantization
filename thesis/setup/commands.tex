...
\newcommand{\makecover}{%
  \begin{titlepage}
    \centering
    \vspace*{2cm}
    {\zihao{1}\songti\bfseries 华南理工大学} \\[0.5cm]
    {\zihao{2}\songti\bfseries 本科毕业设计（论文）} \\[3cm]
    {\zihao{2}\songti\bfseries \thesistitle} \\[4cm]
    \begin{tabular}{rl}
      {\zihao{4}\songti\bfseries 学\qquad 院：} & {\zihao{4}\songti \thesiscollege} \\[0.5em]
      {\zihao{4}\songti\bfseries 专\qquad 业：} & {\zihao{4}\songti \thesismajor} \\[0.5em]
      {\zihao{4}\songti\bfseries 学生姓名：}    & {\zihao{4}\songti \thesisauthor} \\[0.5em]
      {\zihao{4}\songti\bfseries 学生学号：}    & {\zihao{4}\songti \thesisstudentid} \\[0.5em]
      {\zihao{4}\songti\bfseries 指导教师：}    & {\zihao{4}\songti \thesissupervisor} \\[0.5em]
      {\zihao{4}\songti\bfseries 提交日期：}    & {\zihao{4}\songti \thesissubmitdate} \\
    \end{tabular}
  \end{titlepage}
}
...
\newcommand{\makedeclaration}{%
  ...
  \thispagestyle{empty}
  \begin{center}
    {\zihao{2}\songti\bfseries 华南理工大学\\学位论文原创性声明}
  \end{center}
  ...
  \vspace{2cm}
  \begin{center}
    {\zihao{2}\songti\bfseries 学位论文版权使用授权书}
  \end{center}
  \vspace{0.5\baselineskip}
...
\newenvironment{abstractzh}{%
  \clearpage
  \begin{center}
    {\zihao{-2}\songti\bfseries 摘\qquad 要}
  \end{center}
  \vspace{0.5\baselineskip}
  \zihao{-4}\songti\setlength{\parindent}{2em}
}{}
...
\newcommand{\keywordszh}[1]{%
  ...
  {\zihao{-4}\songti\bfseries 关键词：}{\zihao{-4}\songti #1}
}
