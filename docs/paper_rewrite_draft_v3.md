...
Figure 1 should make this reading rule explicit before the paper enters technical detail. Rather than visualizing three parallel contributions, it should present one causal chain from analysis object to framework validation to allocator reading.
