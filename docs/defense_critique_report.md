...
### 审稿人 6（补充）：论文写作教授 | 评级 B+

**结构问题**：
- 第四章 1571 行占全文 35%（目标 25-30%），需瘦身 300-400 行到附录
- 第一章 1.3 节研究现状仅 30 行，偏薄，缺批判性分析
- 5.1/5.2 内容高度重复，需合并

**Overclaim**：
- "完整方法论闭环"出现 5 次（摘要/绪论/方法/实验/结论各 1 次）→ 保留 1 次
- "统一原则"的"统一"支撑不足（诊断实际用 PPL/Needle 而非 KL 值）
- 结语"任何涉及中间表示压缩的场景"泛化过度
...
| Claim | 完整性 | 关键缺口 |
|-------|--------|---------|
| Claim 1 | 充分 | RULER -2.64% 需限定"INT8 精度下" |
| Claim 2 | 充分 | K/V PPL 消融仅 1.5B 单模型 |
| Claim 3 | 基本充分 | PPL 13.7% 与"恢复"暗示矛盾 |
| Claim 4 | 充分 | 边界分析坦诚无 overclaim |

**TOP 10 修改建议**：
1. 第四章瘦身（敏感性分析、KIVI 对比细节→附录）
2. 合并 5.1/5.2
3. 扩展 1.3 节研究现状
4. tau^{-1} 移附录
5. "闭环/统一/核心洞察"去重
6. 收紧 overclaim（结语泛化声明）
7. 补强 Claim 2 "诊断透镜"逻辑
8. 图 1.1/3.1 替换为矢量图
9. 破折号和模板句式 de-AI
10. 第二章按技术路线重组 KV Cache 量化工作
