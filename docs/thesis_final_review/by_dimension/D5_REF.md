...
## P3c 批次 2 执行记录（2026-04-17）

### TR-0505 venue 迁移（已执行，6 条）

| bibkey | 原 venue | 新 venue | 说明 |
|--------|----------|----------|------|
| hooper2024kvquant | arXiv:2401.18079 | NeurIPS 2024 | 同时修正作者拼写 Mohber→Mohammadzadeh |
| liu2024intactkv | arXiv:2403.01241 | Findings of ACL 2024 | 同时修正作者列表（原作者严重错误） |
| xiao2024duoattention | arXiv:2410.10819 | ICLR 2025 | year 2024→2025 |
| lin2024qserve | arXiv:2405.04532 | MLSys 2025 | year 2024→2025 |
| shutova2025aquakv | arXiv:2501.19392 | ICML 2025 | — |
| tao2024asymkv | arXiv:2410.13212 | COLING 2025 | year 2024→2025 |

### TR-0506 `and others` GB/T 7714 合规（已执行，6 条）

按规范「前 3 位作者 + others」补全：

| bibkey | 修改 | 备注 |
|--------|------|------|
| agarwal2025qerl | Huang, Wei and Ge, Yi and Yang, Shuai and others | 注意：实际作者为 Huang 等，保留 bibkey 以免破坏引用 |
| du2026bitdecoding | Du, Dayou and Cao, Shijie and Cheng, Jianyi and others | — |
| gu2025ahakv | Gu, Yifeng and Jiang, Zicong and Jin, Jianxiu and others | — |
| tao2024asymkv | Tao, Qian and Yu, Wenyuan and Zhou, Jingren | 3 作者完整列出（无需 others） |
| fu2025headkv | Fu, Yu and Cai, Zefan and Asi, Abedelkadir and others | — |
| fogliato2024precise | Fogliato, Riccardo and Patil, Pratik and Akpinar, Nil-Jana and Monfort, Mathew | 4 作者完整列出 |

其余已有 `and others` 条目（grattafiori2024llama3, jiang2023mistral）已满足前 3+ others 规范，无需修改。

### TR-0507 DOI 补全（**不执行**，列为后续工作）

77/78 条缺 DOI 字段。按 P3c 任务定义此为"工作量大且非硬伤"，不在本轮 P3c 处理。建议：
- 优先级：L
- 后续处理建议：批量运行脚本从 arxiv API 或 crossref API 抓取 DOI，人工核对。
