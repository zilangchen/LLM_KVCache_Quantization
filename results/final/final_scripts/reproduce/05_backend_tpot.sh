...
# ================================================================
# 输出: results/final/final_data/backend_comparison/runs/tpot_*
# 内容: 4 模型 × 6 后端 (fp16, torchref, kivi, triton_ra, fi, bd) Phase 1 TPOT
# 原始脚本: scripts/batch_p012/stage1_phase1_rerun.sh + phase1_fix_8b_14b.sh
# GPU 时间: ~3-4h (需独占 GPU)
# ================================================================
set -euo pipefail
...
OUTDIR="results/final/final_data/backend_comparison/runs"
