...
- **Tier 1** (进行中): 校准策略重评估 — 仅 1.5B, 固定 T0-C 配置
  - [ ] 生成 MSE 校准: `kv_calib_mse_int4_v4_g16.json`
  - [ ] 生成 percentile 校准: `kv_calib_pctl_int4_v4_g16.json`
  - [ ] 重生 KL 校准: `kv_calib_kl_int4_v4_g16.json`
  - [ ] 对比实验 (3 校准 × PPL+Needle)
  - [ ] Go/No-Go 判定
