...
### 2026-04-04 04:23 | Plan: 论文终版 + 答辩准备 (Phase A-C)
- **状态**: 执行中
- **前置条件**: E-4 Triton kernel 完成 ✅，4 个 GPU 实验运行中
- Checklist:
  - [x] A1. Codex review ✅ 4 findings (P1+3×P2) 全部修复，5/5 测试通过
  - [ ] A2. E-4b TPOT profiling [GPU 独占] — 等 GPU 空闲
  - [x] A3-partial. Exp-4 KIVI residual 收割 ✅ res=0/64/128 PPL 全 10.43，零影响
  - [x] A3-partial. LongBench v2 收割 ✅ 3 CSV 已下载
  - [x] B1. TPOT 精确数据写入 ch4 ✅ tab:int4-tpot-cross-model (commit 11f26ca)
  - [x] B2. Batch>1 附录 ✅ tab:app-batch-ra-scaling (commit 11f26ca)
  - [x] B3-partial. ch3 INT4 非对称融合核设计小节 ✅ (commit 6bef56c)
  - [x] B3-partial. ch5 Limitations 更新 ✅ (commit e61efa6)
  - [x] B3-partial. ch4 KIVI residual 验证写入 ✅ (commit e61efa6)
  - [ ] B3-final. ch4 boundary 段更新 fused TPOT 数字 [等 E-4b 数据]
  - [x] B4. cs 敏感性确认完整 ✅ + KIVI cs=1 数字修正 (commit d700767)
  - [ ] B5. E-3 n=10 统计更新 [等数据, 29/75 dirs]
  - [ ] B6. Exp-2 集成 [等数据, on s1236]
  - [ ] C1. 全文数字一致性 [本地]
  - [ ] C2. 答辩 Q&A [本地]
  - [ ] C3. 答辩 PPT [本地]
