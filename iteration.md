...
- Checklist:
  - [x] A1. Codex review [本地] — 后台运行中
  - [ ] A2. E-4b TPOT profiling [GPU 独占]
  - [ ] A3. 实验数据收割 [GPU 完成后]
  - [ ] B1. TPOT 精确数据写入 ch4 [本地] ← 立刻开始
  - [ ] B2. Batch>1 附录 [本地]
  - [ ] B3. INT4 Triton 融合核写入 ch3+ch4+ch5 [等 TPOT 数据]
  - [ ] B4. cs 敏感性 + LongBench v2 [本地]
  - [ ] B5. E-3 n=10 统计更新 [等数据]
  - [ ] B6. Exp-2/4 集成 [等数据]
  - [ ] C1. 全文数字一致性 [本地]
  - [ ] C2. 答辩 Q&A [本地]
  - [ ] C3. 答辩 PPT [本地]
